...
void admin_NOW_MV_input()
{
	...
	int count = 0;
	while (fread(&check, sizeof(check), 1, fpr) == 1) {
		count++;
	}
	fclose(fpr);
	if (count < 10) {
		...
		printf("======================================================================================================\n");
		printf("\n\n");
		printf("                                KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - »ó¿µÀÛ Ãß°¡\n");
		printf("\n\n");
		printf("                                 ¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤\n");
		printf("                                 ¦¢ Á¦¸ñ:                         ¦¢\n");
		printf("                                 ¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥\n");
		...
		if (fp == NULL) {
			printf("ÆÄÀÏÀ» »ý¼ºÇÒ¼ö°¡ ¾ø½À´Ï´Ù.\n");
			return;
		}
		fwrite(&MV, sizeof(NOW), 1, fp);
		printf("\n\n\n\n\n");
		printf("                                       Ãß°¡°¡ ¿Ï·áµÇ¾ú½À´Ï´Ù.\n");
		...
		printf("                                KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - »ó¿µÀÛ Ãß°¡\n");
		printf("\n\n");
		printf("                                 »ó¿µÀÛÀ» ´õÀÌ»ó µî·ÏÇÒ ¼ö ¾ø½À´Ï´Ù.\n");
		printf("                                    ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
		return;
...
void admin_REC_MV_input()
{
	...
	if (count < 12) {
		...
		printf("======================================================================================================\n");
		printf("\n\n");
		printf("                          KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ¼±È£ Àå¸£ ºÐ¼®¿ë DB Ãß°¡\n");
		printf("\n\n");
		printf("                                 ¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤\n");
		printf("                                 ¦¢ Á¦¸ñ:                         ¦¢\n");
		printf("                                 ¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥\n");
		...
		if (fp == NULL) {
			printf("                          ÀÏ½ÃÀûÀ¸·Î ÆÄÀÏÀ» ¿­Áö ¸øÇß½À´Ï´Ù. ´Ù½Ã ½ÃµµÇØÁÖ¼¼¿ä.\n");
			printf("                                     ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
			_getch();
			return;
		}
		...
		printf("                          KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ¼±È£ Àå¸£ ºÐ¼®¿ë DB Ãß°¡\n");
		printf("\n\n");
		printf("                                  DB¸¦ ´õÀÌ»ó µî·ÏÇÒ ¼ö ¾ø½À´Ï´Ù.\n");
		printf("                                    ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
		return;
	}
...
void NOW_MV_del()
{
	...
	if (fpr == NULL) {
		...
		printf("======================================================================================================\n");
		printf("\n\n");
		printf("                             KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ÇöÀç »ó¿µÀÛ »èÁ¦\n");
		printf("\n\n");
		printf("                                     ÇöÀç µî·ÏµÈ DB°¡ ¾ø½À´Ï´Ù.\n");
		printf("                                    ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
		fpr = fopen("D:/NOW_MV_LIST.txt", "wb");
		fclose(fpr);
	...
	{
		printf("\n\n\n\n");
		printf("                             ÀÔ·ÂÇÏ½Å ¿µÈ­°¡ Á¸ÀçÇÏÁö ¾Ê½À´Ï´Ù.\n"); 
		printf("                                ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
		return;
	}
...
void REC_MV_del(){
	...
	if (fpr == NULL) {
		...
		printf("======================================================================================================\n");
		printf("\n\n");
		printf("                         KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ¼±È£ Àå¸£ ºÐ¼®¿ë DB »èÁ¦\n");
		printf("\n\n");
		printf("                                    ÇöÀç µî·ÏµÈ DB°¡ ¾ø½À´Ï´Ù.\n");
		printf("                                   ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
...
void NOW_MV_read()
{
	...
	if (fp == NULL) {
		...
		printf("======================================================================================================\n");
		printf("\n\n");
		printf("                              KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ÇöÀç »ó¿µÀÛ ¸ñ·Ï\n");
		printf("\n\n");
		printf("                                   ÇöÀç µî·ÏµÈ »ó¿µÀÛÀÌ ¾ø½À´Ï´Ù.\n");
		printf("                                    ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
	...
	gotoxy(0, 40);
	printf("                                 ÇöÀç »ó¿µÁßÀÎ ¿µÈ­´Â À§¿Í °°½À´Ï´Ù.\n");
	printf("                                    ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
	_getch();
	fclose(fp);
}
...
void REC_MV_read()
{
	...
	if (fp == NULL) {
		...
		printf("======================================================================================================\n");
		printf("\n\n");
		printf("                           KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ¼±È£ Àå¸£ ºÐ¼®¿ë DB ¸ñ·Ï\n");
		printf("\n\n");
		printf("                                      ÇöÀç µî·ÏµÈ DB°¡ ¾ø½À´Ï´Ù.\n");
		printf("                                     ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
	...
	while (fread(&rec, sizeof(rec), 1, fp) == 1) {
		gotoxy(x, y + i); printf("%d", ++count);
		gotoxy(x + 7, y + i); printf("%s (°¨µ¶: %s, ÁÖ¿¬: %s)", rec.name, rec.director, rec.actor);
	...
	gotoxy(0, 44);
	printf("                                  ÇöÀç µî·ÏµÈ DB´Â À§¿Í °°½À´Ï´Ù.\n");
	printf("                                    ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
	_getch();
	fclose(fp);
}
...
void book_init() {
	...
	printf("======================================================================================================\n");
	printf("\n\n");
	printf("                               KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ¿¹¸Å ³»¿ª ÃÊ±âÈ­\n");
	printf("\n\n");
	printf("                                  ÀúÀåµÈ ¸ðµç ¿¹¸Å ³»¿ªÀ» ÃÊ±âÈ­ÇÕ´Ï´Ù.\n");
	printf("                                        Á¤¸» ÁøÇàÇÏ½Ã°Ú½À´Ï±î?\n");
	printf("                                      (°æ°í! µ¹ÀÌÅ³ ¼ö ¾ø½À´Ï´Ù!)\n");
	printf("\n\n");
	printf("                             ¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤             ¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤\n");
	printf("                             ¦¢ 1. »èÁ¦     ¦¢             ¦¢ 2. Ãë¼Ò     ¦¢\n");
	printf("                             ¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥             ¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥\n");
	...
	if (select == 1) {
		...
		printf("                               KB ½Ã³×¸¶ °ü¸®ÀÚ¿ë ¸Þ´º - ¿¹¸Å ³»¿ª ÃÊ±âÈ­\n");
		printf("\n\n");
		printf("                                   ¸ðµç ¿¹¸Å ³»¿ªÀÌ ÃÊ±âÈ­µÇ¾ú½À´Ï´Ù.\n");
		printf("                                      ¾Æ¹« Å°³ª ´©¸£¸é µ¹¾Æ°©´Ï´Ù.\n");
		_getch();
		return;
	}
